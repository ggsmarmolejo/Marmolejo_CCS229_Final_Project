...
theme_prompts = {
  "Pop": "Breakup Anthem", "Empowerment Song", "Summer Love",
  "Rock": "Rebellion", "Facing Your Fears", "Heartbreak Ballad",
  "Hip-Hop": "Struggle and Success", "Party Anthem", "Social Commentary",
  "Country": "Lost Love", "Life on the Farm", "Small Town Dreams",
  "Electronic": "Dystopian Future", "Euphoric Dancefloor", "Nostalgia for the Past",
}
